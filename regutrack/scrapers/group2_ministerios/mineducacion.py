"""Ministerio de Educación scraper."""
...
_BASE = "https://www.mineducacion.gov.co"

class MineducacionScraper(BaseScraper):
    entity_name = "Ministerio de Educación"
    entity_url = f"{_BASE}/portal/normativa/"
    entity_group = "group2_ministerios"
    doc_type_default = "Norma Educación"
