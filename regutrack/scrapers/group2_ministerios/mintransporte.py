"""Ministerio de Transporte scraper."""
...
_BASE = "https://www.mintransporte.gov.co"

class MintransporteScraper(BaseScraper):
    entity_name = "Ministerio de Transporte"
    entity_url = f"{_BASE}/transparencia/normatividad/"
    entity_group = "group2_ministerios"
    doc_type_default = "Norma Transporte"
